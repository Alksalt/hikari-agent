"""``read_attachment`` — scoped attachment reader.

Only reads from ``data/user_photos/`` and ``data/user_documents/``.
Replaces unscoped Read/Glob/Grep for the photo/voice/document handlers.
"""
